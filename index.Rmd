...
Once in class, go to the workshop folder (point 1 above) and double-click on the workshop _R project_ file (`Egocentric_R.Rproj`) in it. That will open RStudio.
